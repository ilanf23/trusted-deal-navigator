  ...
  return (
    <div className="w-80 border-l border-border bg-background dark:bg-slate-900 overflow-y-auto">
      ...
      <div className="px-4 pt-4 pb-3 border-b border-border">
        <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">CRM Lead Info</h3>
      </div>
      ...
      <div className="px-4 py-3 border-b border-border flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div>
            ...
            >
              <SelectTrigger className="h-8 w-[130px] text-sm bg-background rounded-lg">
        ...
        <div className="px-4 py-4 space-y-1">
          ...
          <div className="space-y-3 pl-6 py-3">
            ...
            <div>
              ...
              >
                <SelectTrigger className="h-8 text-sm bg-background rounded-lg">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="bg-popover">
          ...
          <div className="space-y-2 pl-6 py-3">
            {(!selectedLead.lead_contacts || selectedLead.lead_contacts.length === 0) ? (
              ...
              selectedLead.lead_contacts.map((contact: any) => (
                <div key={contact.id} className="py-3 border-b border-border last:border-0">
                  <div className="flex items-center gap-2">
            ...
            <button className="inline-flex items-center gap-1 text-xs text-primary hover:text-primary/80 font-medium mt-2 transition-colors duration-150">
          ...
          <div className="pt-4">
            <Button
              className="w-full bg-[#0066FF] hover:bg-[#0052CC] text-white rounded-lg"
              onClick={(e) => {
                e.stopPropagation();
