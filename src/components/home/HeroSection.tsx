...
import CLXHeroAnimation from "./CLXHeroAnimation";
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center hero-gradient overflow-hidden">
      ...
      <div className="section-container relative z-10 py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="max-w-xl">
            {/* Trust Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-foreground/10 backdrop-blur-sm rounded-full text-primary-foreground/90 text-sm font-medium mb-6 animate-fade-in">
              <Shield className="w-4 h-4" />
              Trusted by 500+ Business Owners & Investors
            </div>

            {/* Main Headline */}
            <h1 className="text-primary-foreground mb-4 animate-fade-in-up text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
              Commercial Financing Expertise{" "}
              <span className="text-accent">for Real-World Deals</span>
            </h1>

            {/* Subheadline */}
            <p className="text-lg md:text-xl text-primary-foreground/80 mb-6 leading-relaxed animate-fade-in-up animation-delay-100">
            ...
            {/* Highlights */}
            <div className="flex flex-wrap gap-4 mb-8 animate-fade-in-up animation-delay-200">
          ...
          <div className="relative animate-fade-in-up animation-delay-200 hidden md:block">
            <CLXHeroAnimation />
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 animate-bounce hidden lg:block">
        <div className="w-5 h-8 rounded-full border-2 border-primary-foreground/30 flex items-start justify-center p-1.5">
