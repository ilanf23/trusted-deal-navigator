...
interface AIEmailAssistantSheetProps {
  isOpen: boolean;
  onClose: () => void;
...
const AIEmailAssistantSheet = ({ isOpen, onClose, lead, onUseEmail }: AIEmailAssistantSheetProps) => {
      ...
      <SheetContent side="right" className="w-full sm:max-w-lg p-0 flex flex-col">
        <SheetHeader className="p-4 border-b shrink-0">
          <div className="flex items-center gap-2">
            <img src={chatgptLogo} alt="AI Agent" className="w-5 h-5 object-contain" />
...
export default AIEmailAssistantSheet;
