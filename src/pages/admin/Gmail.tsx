...
const Gmail = () => {
  ...
  usePageDatabases([
    { table: 'gmail-auth / gmail-mailbox / gmail-write', access: 'rpc', usage: 'Edge function proxies for Gmail API. gmail-auth: OAuth + connection status. gmail-mailbox: list/get/labels (read). gmail-write: send/archive/trash/mark-read/create-draft.', via: 'src/hooks/useGmail.ts via GmailCore' },
