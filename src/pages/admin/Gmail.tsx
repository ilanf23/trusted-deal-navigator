...
const Gmail = () => {
  ...
  usePageDatabases([
    { table: 'google-auth / gmail-mailbox / gmail-write', access: 'rpc', usage: 'Edge function proxies for Gmail API. google-auth: OAuth + connection status. gmail-mailbox: list/get/labels (read). gmail-write: send/archive/trash/mark-read/create-draft.', via: 'src/hooks/useGmail.ts via GmailCore' },
    ...
    { table: 'google_connections', access: 'read', usage: 'Connected Gmail accounts for the current user.', via: 'src/hooks/useGmailConnection.ts' },
  ]);
  return (
    <EmployeeLayout>
