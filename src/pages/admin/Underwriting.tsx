                    ...
                    {isLoading ? (
                      Array.from({ length: 7 }).map((_, i) => (
                        <tr key={i} className="bg-white dark:bg-card border-b border-[#e4dced] dark:border-border/40">
                          ...
                          <td className="px-4 py-3.5 sticky z-[5] border-r border-b border-[#e4dced] dark:border-border/40 bg-white dark:bg-card" style={{ width: columnWidths.opportunity, left: 48 }}>
                      ...
                      filteredAndSorted.map((lead, rowIdx) => {
                        ...
                        return (
                          ...
                          >
                            {/* Checkbox */}
                            <td
                              className={`pl-2 pr-4 py-3 w-12 text-center sticky left-0 z-[5] transition-colors border-b border-[#e4dced] dark:border-border/40 ${stickyBg}`}
                            ...
                            {/* Opportunity (sticky) */}
                            <td className={`px-4 py-3 overflow-hidden sticky z-[5] transition-colors border-x border-b border-[#e4dced] dark:border-border/40 ${stickyBg}`} style={{ width: columnWidths.opportunity, left: 48 }}>
                              <div className="flex items-center gap-2.5">
                            ...
                            {columnVisibility.value && (
                              <td className="px-4 py-3 overflow-hidden border-r border-[#e4dced] dark:border-border/30" style={{ width: columnWidths.value }}>
                            ...
                            {columnVisibility.ownedBy && (
                              <td className="px-4 py-3 overflow-hidden border-r border-[#e4dced] dark:border-border/30" style={{ width: columnWidths.ownedBy }}>
                            ...
                            {columnVisibility.stage && (
                              <td className="px-4 py-3 overflow-hidden border-r border-[#e4dced] dark:border-border/30" style={{ width: columnWidths.stage }}>
                                {stageCfg ? (
                                  ...
                                  <span className="text-[#5f6368] dark:text-muted-foreground text-xs">{lead._stageName ?? lead.status}</span>
                                )}
                              </td>
                            )}
                            ...
                            {columnVisibility.daysInStage && (
                              <td className="px-4 py-3 overflow-hidden border-r border-[#e4dced] dark:border-border/30" style={{ width: columnWidths.daysInStage }}>
                                {daysInStage !== null ? (
                            ...
                            {columnVisibility.stageUpdated && (
                              <td className="px-4 py-3 overflow-hidden border-r border-[#e4dced] dark:border-border/30" style={{ width: columnWidths.stageUpdated }}>
