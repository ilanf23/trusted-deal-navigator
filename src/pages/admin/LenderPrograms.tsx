...
const COLUMNS = [
  ...
  { key: 'lender_type', label: 'Lender Type', width: 120, editable: true },
  { key: 'loan_size_text', label: 'Loan Size', width: 120, editable: true },
  { key: 'loan_types', label: 'Loan Types', width: 150, editable: true },
  { key: 'states', label: 'States', width: 100, editable: true },
  { key: 'location', label: 'Location', width: 120, editable: true },
  { key: 'contact_name', label: 'Contact', width: 130, editable: true },
