...
BEGIN
  IF EXISTS (
    ...
    WHERE table_schema = 'public' AND table_name = 'team_monthly_goals' AND column_name = 'team_member_name'
  ) THEN
    EXECUTE '
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'dashboard_deals' AND column_name = 'owner_name'
  ) THEN
    EXECUTE '
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'email_templates' AND column_name = 'team_member_name'
  ) THEN
    EXECUTE '
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'bug_reports' AND column_name = 'assigned_to'
  ) THEN
    EXECUTE '
...
BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'team_funded_deals' AND column_name = 'rep_name'
  ) THEN
    EXECUTE '
